...
- `winStreakThreshold` for win streak length, default is 10
...
- your attendees have huge gap between their experience level, increasing `winStreakThreshold` is adviced
